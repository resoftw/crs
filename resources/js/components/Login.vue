            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                <div class="layout column align-center">
                  <img src="../../images/logo 128.png" alt="Logo Baturaja" width="128" height="128">
                  <h1 class="flex my-4 primary--text font-weight-regular headline">CUSTOMER RELATIONSHIP SYSTEM</h1>
                </div>                
                <v-form>
